...
import { Brain, BarChart3, Zap, Users, Sparkles, Shield } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    description: "Track campaign performance with real-time insights and predictive analytics."
  },
  {
    icon: <Zap className="w-8 h-8" />,
    title: "Automated Campaigns",
    description: "Set up and optimize marketing campaigns that run themselves with AI automation."
  },
  {
    icon: <Users className="w-8 h-8" />,
    title: "Audience Targeting",
    description: "Identify and reach your perfect customers with precision AI-powered targeting."
  },
  {
    icon: <Sparkles className="w-8 h-8" />,
    title: "Creative Optimization",
    description: "A/B test and optimize your creative assets automatically for maximum impact."
  },
  {
...
const Features = ({ animatedElements }) => (
    ...
    <div className="max-w-7xl mx-auto">
      <div
        ...
        className={`text-center mb-16 transform transition-all duration-1000 delay-200 ${
          animatedElements.has("features-header") ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
        }`}
      >
